...
//!
//! The scheduler is generic over [`JobExecutor`], which decouples it from
//! handler implementations. The concrete dispatch logic lives in a separate
...
//!
//! [`JobExecutor`]: mosaic_job_api::JobExecutor

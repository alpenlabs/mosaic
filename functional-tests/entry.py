...
from common.logging import setup_root_logger
from envs.mosaic_env import MosaicTestRuntime
from factories import FactoryType, FdbFactory, MosaicFactory
...
def main(argv: list[str]) -> int:
    ...
    # Create factories
    factories: dict[FactoryType, flexitest.Factory] = {
        FactoryType.FoundationDB: FdbFactory(range(20395, 20400)),
        FactoryType.Mosaic: MosaicFactory(range(20400, 20500)),
    }
    ...
    runtime = MosaicTestRuntime(global_envs, datadir, factories)
